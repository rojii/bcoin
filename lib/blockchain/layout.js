...
const layout = {
  u: bdb.key('u', ['hash256']),                  // unspent withdrawalHash
  p: bdb.key('p', ['hash256', 'uint32']),        // input bundle withdrawalHash
  s: bdb.key('s', ['hash256', 'uint32']),        // spent withdrawalHash
  c: bdb.key('c', ['uint8', 'hash256']),         // withdrawal bundle created
  f: bdb.key('f'),                               // failed withdrawal bundle
  o: bdb.key('o'),                               // spent withdrawal bundle
  W: bdb.key('W', ['hash256']),                  // WITHDRAWAL_OP
  P: bdb.key('P', ['hash256', 'uint32']),        // Withdrawal Bundle_OP
  Y: bdb.key('Y', ['hash256', 'uint32']),       // DEPOSIT_OP
  V: bdb.key('V'),
  O: bdb.key('O'),
  R: bdb.key('R'),
  D: bdb.key('D'),
